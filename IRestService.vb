...
#Region "Common APIs"
    ...
    <OperationContract()>
    <WebInvoke(Method:="POST", UriTemplate:="GetCanteenCalendarRecord?datetime={datetime}")>
    Function GetCanteenCalendarRecord(ByVal datetime As Date) As CanteenCalendarRecord

    ' From the current date, returns the next future calendar record
    <OperationContract()>
    <WebInvoke(Method:="POST", UriTemplate:="GetCanteenCalendarRecord")>
    Function GetNextCanteenCalendarRecord() As CanteenCalendarRecord
#End Region
...
#Region "Employee APIs - Order APIs"
    ...
    ' Same as Concessionaire APIs - Employee Order APIs GetCanteenCustomerOrder
    <OperationContract()>
    <WebInvoke(Method:="POST", UriTemplate:="GetAllCanteenOrders?username={username}")>
    Function GetAllCanteenOrders(ByVal username As String) As List(Of CanteenOrder)
#End Region
#End Region
...
#Region "HR/Admin APIs - Menu Item APIs"
    <OperationContract()>
    <WebInvoke(Method:="POST", UriTemplate:="SaveCanteenMenuItem?name={name}&description={description}&filepath={filepath}")>
    Function SaveCanteenMenuItem(ByVal name As String, ByVal description As String, ByVal filepath As String) As Boolean
...
#Region "Concessionaire APIs - Employee Order APIs"
    ...
    ' From the current date, returns the next future set of customer orders
    <OperationContract()>
    <WebInvoke(Method:="POST", UriTemplate:="GetNextScheduledCanteenCustomerOrders?username={username}")>
    Function GetNextScheduledCanteenCustomerOrders(ByVal username As String) As CanteenOrder
#End Region
#End Region
End Interface
